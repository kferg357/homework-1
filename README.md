In this assignment we focused on refactoring code which is improving the code without changing what it does. The criteria that was set for us to meet are the following:
